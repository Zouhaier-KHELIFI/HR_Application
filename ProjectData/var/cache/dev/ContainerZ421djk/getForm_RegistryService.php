...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('AppBundle\\Form\\AbsenceType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\AbsenceType']) ? $this->services['AppBundle\Form\AbsenceType'] : ($this->services['AppBundle\Form\AbsenceType'] = new \AppBundle\Form\AbsenceType())) && false ?: '_'};
}, 'AppBundle\\Form\\CandidatureType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\CandidatureType']) ? $this->services['AppBundle\Form\CandidatureType'] : ($this->services['AppBundle\Form\CandidatureType'] = new \AppBundle\Form\CandidatureType())) && false ?: '_'};
}, 'AppBundle\\Form\\DemandeType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\DemandeType']) ? $this->services['AppBundle\Form\DemandeType'] : ($this->services['AppBundle\Form\DemandeType'] = new \AppBundle\Form\DemandeType())) && false ?: '_'};
}, 'AppBundle\\Form\\DepartementType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\DepartementType']) ? $this->services['AppBundle\Form\DepartementType'] : ($this->services['AppBundle\Form\DepartementType'] = new \AppBundle\Form\DepartementType())) && false ?: '_'};
}, 'AppBundle\\Form\\EvennementType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\EvennementType']) ? $this->services['AppBundle\Form\EvennementType'] : ($this->services['AppBundle\Form\EvennementType'] = new \AppBundle\Form\EvennementType())) && false ?: '_'};
...
}, 'AppBundle\\Form\\OffreEmploieType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\OffreEmploieType']) ? $this->services['AppBundle\Form\OffreEmploieType'] : ($this->services['AppBundle\Form\OffreEmploieType'] = new \AppBundle\Form\OffreEmploieType())) && false ?: '_'};
}, 'AppBundle\\Form\\RatingType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\RatingType']) ? $this->services['AppBundle\Form\RatingType'] : ($this->services['AppBundle\Form\RatingType'] = new \AppBundle\Form\RatingType())) && false ?: '_'};
...
}, 'UserBundle\\Form\\Type\\ChangePasswordFormType' => function () {
    return ${($_ = isset($this->services['fos_user.change_password.form.type']) ? $this->services['fos_user.change_password.form.type'] : ($this->services['fos_user.change_password.form.type'] = new \UserBundle\Form\Type\ChangePasswordFormType('AppBundle\\Entity\\User'))) && false ?: '_'};
}, 'UserBundle\\Form\\Type\\ProfileFormType' => function () {
    return ${($_ = isset($this->services['fos_user.profile.form.type']) ? $this->services['fos_user.profile.form.type'] : ($this->services['fos_user.profile.form.type'] = new \UserBundle\Form\Type\ProfileFormType('AppBundle\\Entity\\User'))) && false ?: '_'};
}, 'UserBundle\\Form\\Type\\RegistrationFormType' => function () {
    return ${($_ = isset($this->services['fos_user.registration.form.type']) ? $this->services['fos_user.registration.form.type'] : ($this->services['fos_user.registration.form.type'] = new \UserBundle\Form\Type\RegistrationFormType('AppBundle\\Entity\\User'))) && false ?: '_'};
}, 'UserBundle\\Form\\Type\\ResettingFormType' => function () {
    return ${($_ = isset($this->services['fos_user.resetting.form.type']) ? $this->services['fos_user.resetting.form.type'] : ($this->services['fos_user.resetting.form.type'] = new \UserBundle\Form\Type\ResettingFormType('AppBundle\\Entity\\User'))) && false ?: '_'};
}, 'UserBundle\\Form\\Type\\UsernameFormType' => function () {
