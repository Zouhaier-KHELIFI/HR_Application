...
return $this->services['console.command_loader'] = new \Symfony\Component\Console\CommandLoader\ContainerCommandLoader(new \Symfony\Component\DependencyInjection\ServiceLocator(array('console.command.about' => function () {
    ...
    $f = function (\UserBundle\Command\ActivateUserCommand $v) { return $v; }; return $f(${($_ = isset($this->services['fos_user.command.activate_user']) ? $this->services['fos_user.command.activate_user'] : $this->load('getFosUser_Command_ActivateUserService.php')) && false ?: '_'});
}, 'fos_user.command.change_password' => function () {
    $f = function (\UserBundle\Command\ChangePasswordCommand $v) { return $v; }; return $f(${($_ = isset($this->services['fos_user.command.change_password']) ? $this->services['fos_user.command.change_password'] : $this->load('getFosUser_Command_ChangePasswordService.php')) && false ?: '_'});
}, 'fos_user.command.create_user' => function () {
    $f = function (\UserBundle\Command\CreateUserCommand $v) { return $v; }; return $f(${($_ = isset($this->services['fos_user.command.create_user']) ? $this->services['fos_user.command.create_user'] : $this->load('getFosUser_Command_CreateUserService.php')) && false ?: '_'});
}, 'fos_user.command.deactivate_user' => function () {
    $f = function (\UserBundle\Command\DeactivateUserCommand $v) { return $v; }; return $f(${($_ = isset($this->services['fos_user.command.deactivate_user']) ? $this->services['fos_user.command.deactivate_user'] : $this->load('getFosUser_Command_DeactivateUserService.php')) && false ?: '_'});
}, 'fos_user.command.demote_user' => function () {
    $f = function (\UserBundle\Command\DemoteUserCommand $v) { return $v; }; return $f(${($_ = isset($this->services['fos_user.command.demote_user']) ? $this->services['fos_user.command.demote_user'] : $this->load('getFosUser_Command_DemoteUserService.php')) && false ?: '_'});
}, 'fos_user.command.promote_user' => function () {
    $f = function (\UserBundle\Command\PromoteUserCommand $v) { return $v; }; return $f(${($_ = isset($this->services['fos_user.command.promote_user']) ? $this->services['fos_user.command.promote_user'] : $this->load('getFosUser_Command_PromoteUserService.php')) && false ?: '_'});
