...
$a->addDriver(new \Doctrine\ORM\Mapping\Driver\XmlDriver(new \Doctrine\Common\Persistence\Mapping\Driver\SymfonyFileLocator(array(($this->targetDirs[3].'\\src\\UserBundle\\Resources\\config\\doctrine-mapping') => 'UserBundle\\Model'), '.orm.xml')), 'UserBundle\\Model');
